 ...
 */
final class Version20220116175629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL, contenu LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE club (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(45) NOT NULL, date_creation DATE NOT NULL, date_debut_saison DATE NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE equipe (id INT AUTO_INCREMENT NOT NULL, id_club_id INT NOT NULL, id_entraineur_id INT NOT NULL, nom VARCHAR(45) NOT NULL, ville VARCHAR(45) NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_2449BA15BF84A342 (id_club_id), INDEX IDX_2449BA15B1ACA9C4 (id_entraineur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fiche_match (id INT AUTO_INCREMENT NOT NULL, arbitre_principal_id INT NOT NULL, arbitre_assistant1_id INT NOT NULL, arbitre_assistant2_id INT NOT NULL, equipe_domicile_id INT NOT NULL, equipe_exterieure_id INT NOT NULL, status_id INT NOT NULL, date_debut DATETIME NOT NULL, nom VARCHAR(45) NOT NULL, stade VARCHAR(45) NOT NULL, score VARCHAR(255) DEFAULT NULL, buteur_domicile VARCHAR(400) DEFAULT NULL, buteur_exterieur VARCHAR(400) DEFAULT NULL, INDEX IDX_DB2F3A614A633 (arbitre_principal_id), INDEX IDX_DB2F3A1E1A7342 (arbitre_assistant1_id), INDEX IDX_DB2F3ACAFDCAC (arbitre_assistant2_id), INDEX IDX_DB2F3A5FE1AEAD (equipe_domicile_id), INDEX IDX_DB2F3A8923FCCA (equipe_exterieure_id), INDEX IDX_DB2F3A6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
